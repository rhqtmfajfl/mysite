...
public class FileuploadConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry
			.addResourceHandler(env.getProperty("fileupload.resourceMapping"))  //assets로 하면 
			.addResourceLocations("file:" + env.getProperty("fileupload.uploadLocation"));  // file: 로 인해 나온다. 그림이 나온다.
	}
